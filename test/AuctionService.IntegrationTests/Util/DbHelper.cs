...
{
    public static void InitDbForTests(AuctionDbContext auctionDbContext)
    {
        auctionDbContext.Auctions.AddRange(GetAuctionsForTest());
        auctionDbContext.SaveChanges();
    }

    public static void ReinitDbForTests(AuctionDbContext auctionDbContext)
    {
        auctionDbContext.Auctions.RemoveRange(auctionDbContext.Auctions);
        auctionDbContext.SaveChanges();
        InitDbForTests(auctionDbContext);
    }
